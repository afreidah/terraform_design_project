...
# Private Data Tier Route Table (shared)
...
# Private Data Route to NAT Gateway (optional, typically data tier doesn't need internet)
...
# Associate Private Data Subnets with Private Data Route Table
